...
var selectTextDisplay = '¡Elige 6 números\ny comineza el DUELO!';
var selectTextDisplay2 = 'que el juego elija por ti'; //select number text display
...
var spinEndSpeed = 2; //spin starting speed
var spinSpeed = 2; //spin speed
var revealTimer = 2; //reveal ball timer

var prizeTableDisplay = '\nTABLA DE PUNTOS'; //score table text display
var numberTextDisplay = 'TUS NÚMEROS'; //your score text display
var matchTextDisplay = '[NUMBER] NÚMEROS'; //match text display
var scoreTextDisplay = '[NUMBER] PTS'; //prize score text display

//score points array and also the total number to reveal
var score_arr = [50, 100, 200, 300, 400, 600];

var bonusBall = true; //toggle bonus ball
var bonusTextDisplay = '[NUMBER] NÚMEROS + B'; //match bonus text display
var bonusScore = [500]; //bonus score point

var exitMessage = '¿DESEAS SALIR DEL JUEGO?'; //go to main page message
var resultDuelo = '¡EL DUELO ES TUYO!';
var resultDuelo2 = 'SUERTE PARA LA PRÓXIMA';
var resultCompleteText = 'GANASTE [NUMBER] PTS!'; //result complete text display
var resultFailText = '¡VUELVE MAÑANA!'; //result fail text display

//Social share, [SCORE] will replace with game score
var shareEnable = true; //toggle share

var shareTitle = 'PUNTAJE MAS ALTO [SCORE]PTS.'; //social share score title
var shareMessage = '[SCORE]PTS NUEVO'; //social share score message
    ...
    switch (page) {
        ...
        case 'result':
            ...
            if (gameData.matchNum != -1) {
                ...
                resultTitleTxt2.text = resultDuelo;
                saveGame(playerData.score);
            } else {
                playSound('soundFail');
                resultTitleTxt.text = resultFailText;
                resultTitleTxt2.text = resultDuelo2;
                saveGame(0);
            }
            break;
    }
...
function startGame() {
    ...
    for (var n = 0; n < totalNum; n++) {
        ...
        $.prize['text' + n].color = $.prize['score' + n].color = "#fff";
    }
...
function animatePrize(num) {
    ...
    $.prize['text' + num].color = $.prize['score' + num].color = "#06f912";
